    ...
    <div class="auth-form-side">
        <div class="auth-form-wrapper">
            ...
            <div class="text-center mb-4">
                <div class="bg-danger bg-opacity-10 d-inline-flex align-items-center justify-content-center rounded-circle mb-3 text-danger" style="width: 70px; height: 70px;">
                    <i class="bi bi-shield-lock fs-1"></i>
                </div>
                <h4 class="text-dark mb-2">Lupa Kata Sandi?</h4>
                <p class="text-muted small">Jangan khawatir, masukkan email Anda yang terdaftar dan kami akan mengirimkan instruksi untuk mengatur ulang sandi.</p>
            </div>
            ...
            <form method="POST" action="{{ route('lupa.password.submit') }}">
                @csrf
                <div class="clean-input-group">
                    <input type="email" class="clean-input @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}" placeholder="Alamat Email" required autofocus>
            ...
            <div class="text-center mt-5">
                <a href="{{ route('masuk') }}" class="text-decoration-none fw-semibold text-secondary small"><i class="bi bi-arrow-left me-1"></i> Kembali ke Halaman Masuk</a>
            </div>
