    ...
    <div class="auth-form-side">
        <div class="auth-form-wrapper">
            ...
            <div class="text-center mb-4">
                <div class="bg-warning bg-opacity-10 d-inline-flex align-items-center justify-content-center rounded-circle mb-3 text-warning" style="width: 70px; height: 70px;">
                    <i class="bi bi-key fs-1"></i>
                </div>
                <h4 class="text-dark mb-2">Buat Sandi Baru</h4>
                <p class="text-muted small">Buat kata sandi baru yang kuat untuk melindungi akun Anda.</p>
            </div>
            ...
            <form method="POST" action="{{ route('ubah.password.submit') }}">
                ...
                <div class="clean-input-group position-relative">
                    <input type="password" class="clean-input @error('password') is-invalid @enderror" id="password" name="password" placeholder="Kata Sandi Baru" required autofocus>
                ...
                <button type="submit" class="btn-auth-submit mt-3">Perbarui Kata Sandi</button>
            </form>
